...
echo "\$ curl -Lo kops https://github.com/kubernetes/kops/releases/download/1.7.1/kops-${OS_NAME}-amd64"
echo ''
...
#python3 ./update-r53-zone.py --action create --zone ${ZONE} --parent-zone=${PARENT_ZONE}
